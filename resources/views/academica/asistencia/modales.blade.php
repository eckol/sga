                    ...
                    <div class="tab-pane fade show active" id="masist-tab-datos">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="masist_madre" class="form-control form-control-sm bg-light"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label mb-0 fw-bold">Padre / Tutor</label>
                                <input type="text" id="masist_padre" class="form-control form-control-sm bg-light"
                                    readonly>
                            </div>
                            <div class="col-md-12 mt-1">
                                <label class="form-label mb-0 fw-bold">Historial de inscripciones</label>
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered table-hover" style="font-size:0.7rem;">
