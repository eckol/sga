...
<body onload="window.print()">
    ...
    <div class="header" style="margin-top: 15px;">
        <span class="school-name">Escuela Básica N° 1138 Privada Subvencionada "Santa Teresita" - Luque, Paraguay</span>
        <span class="report-title">DOCUMENTOS ADJUNTOS</span>
    </div>
    ...
    <div class="section">
        <div style="text-align: center;">
            @php
                $tiposRequeridos = [
                    1 => 'Cédula de Identidad del Alumno',
                    3 => 'Cédula de Identidad de la Madre',
                    4 => 'Cédula de Identidad del Padre',
                    2 => 'Partida de Nacimiento'
                ];

                // Agrupar los documentos del alumno por tipo para acceso fácil
                $docsCargados = $alumno->documentos->keyBy('tipo_documento_id');
            @endphp
            ...
            @if($docsCargados->intersectByKeys($tiposRequeridos)->isEmpty())
                <div style="font-style: italic; color: #666; margin-top: 50px;">El alumno no posee los documentos digitales
                    requeridos en la base de datos.</div>
            @endif
        </div>
    </div>
