...
<head>
    ...
    <title>Contrato_2027_{{ $alumno->apellidos }}_{{ $alumno->nombres }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .encabezado {
            text-align: center;
            margin-bottom: 5pt;
            border-bottom: 1px solid #414141ff;
            padding-bottom: 4pt;
        }
...
<body>
    ...
    <div class="encabezado">
        <div style="text-align: center; margin-bottom: 6pt;">
            <img src="{{ public_path('img/logo_escudo.svg') }}" style="height: 50pt; width: auto;" alt="Logo" />
        </div>
    ...
    <div class="intro">
        ...
        el/la Señor/a
        <span class="bold">{{ $firmante->nombre }}</span>,
        ...
        <span class="bold">{{ $alumno->nombres }} {{ $alumno->apellidos }}</span>,
    ...
    <div class="autorizaciones">
        ...
        {{-- Constancia conocimiento Normas Convivencia --}}
        <div class="autorizacion-bloque">
            <div class="aut-titulo">Constancia de Conocimiento de Normas de Convivencia</div>
            <div class="aut-texto">
                Dejo constancia de lectura y aceptación sobre las Normas de Convivencia pertenecientes a la Escuela
                Básica N° 1138 Privada Subvencionada y Colegio Privado "Santa Teresita", referente a la función de los
                padres de familia y de los estudiantes.
            </div>
        </div>
